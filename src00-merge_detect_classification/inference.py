...
args.inference_weights = r'./model_detection/ep00394-val_rpn_clss_Loss_0.0008-val_rpn_bbox_Loss_0.0008--val_fast_clss_Loss_0.0389-val_fast_bbox_Loss_0.0130.pth'
...
with torch.no_grad():
	...
	for cnt, img_path in enumerate(test_images):
		...
		all_features = classfication.predict(classfication_model, all_images) # (31, 2048)
